...
class CGIRootFix(object):
    ...
    and you have problems with your myapps root being set to the cgi script's path
    ...
    :param app_root: Defaulting to ``'/'``, you can set this to something else
        if your myapps is mounted somewhere else.
    """
...
class ProxyFix(object):
    ...
    If you have more than one proxy server in front of your myapps, set
    ...
    :param app: the WSGI application
    :param num_proxies: the number of proxy servers in front of the myapps.
    """
...
class HeaderRewriterFix(object):
    ...
    not or to add `X-Powered-By` headers::
        ...
        myapps = HeaderRewriterFix(myapps, remove_headers=['Date'],
